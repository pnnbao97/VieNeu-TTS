...
TEST_CASES = [
    ...
    # URLs
    (
        "Truy cập https://vieneu.io để biết thêm chi tiết.",
        "truy cập hát tê tê pê ét hai chấm xẹt xẹt vê i e nờ e u chấm i o để biết thêm chi tiết.",
    ),
    (
        "Website www.google.com rất hữu ích.",
        "website vê kép vê kép vê kép chấm gờ o o gờ lờ e chấm xê o mờ rất hữu ích.",
    ),
    # Slashes / Địa chỉ
    (
        "Địa chỉ nhà tôi là 123/4 đường Nguyễn Trãi.",
        "địa chỉ nhà tôi là một trăm hai mươi ba xẹt bốn đường nguyễn trãi.",
    ),
    ...
    (
        "Email với tên miền lạ: user@domain.tech",
        "email với tên miền lạ: u ét e rờ a còng đê o mờ a i nờ chấm tê e xê hát",
    ),
]
